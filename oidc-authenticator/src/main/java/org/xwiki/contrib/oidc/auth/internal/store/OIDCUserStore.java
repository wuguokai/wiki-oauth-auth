...
public class OIDCUserStore {
    ...
    public XWikiDocument searchDocument(String userName) throws XWikiException, QueryException {
        Query query = this.queries.createQuery("select doc.name from XWikiDocument doc where doc.name= :name", Query.HQL);
...
//        query.bindValue("subject", subject);
        ...
        DocumentReference userReference = new DocumentReference(documents.get(0), spaceReference);
